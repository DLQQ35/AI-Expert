...
destinations = {
    ...
    "towns": ["Venice", "Bruges", "Santorini", "Cinque Terre"],
    "countryside": ["Tuscany", "Provence", "Cotswolds", "Napa Valley"],
}
...
def recommend():
    print(Fore.CYAN + "What type of destination are you interested in? (beaches, mountains, cities, towns, countryside)")
